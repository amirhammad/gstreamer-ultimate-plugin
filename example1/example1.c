...
static void pad_added_handler (GstElement *src, GstPad *new_pad, CustomData *data)
{
	...
	if (g_str_has_prefix(new_pad_type, "video/x-raw-rgb")) {
		sink_pad = gst_element_get_static_pad (data->convert_video, "sink");
	} else if (g_str_has_prefix (new_pad_type, "audio/x-raw")) {
		sink_pad = gst_element_get_static_pad (data->convert_audio, "sink");
	} else { 
